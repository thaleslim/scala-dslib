...
trait Iterator[NodeType]{
    ...
    def first(): NodeType                   //Move o cursor para o início do Transversable
    def previous(): NodeType                //Move o cursor para o elemento anterior
    def next(): NodeType                    //Move o cursor para o elemento seguinte
